...
export class Consultation{
    ...
    @ManyToOne(()=> ConsultantSpecialty, (consultant_specialty)=>consultant_specialty.consultation)
    @JoinColumn({ name: 'id_consultant_specialty' })
    consultantSpecialty: ConsultantSpecialty;

    @ManyToOne(()=> ScheduleConsultant, (scheduleConsultant)=> scheduleConsultant.consultation)
